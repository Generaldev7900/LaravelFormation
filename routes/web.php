...
Route::get('/', function () {
    ...
    //  dd($etudiants);
        ...
        //Recuperer l'etudiant qui a l'id 1
    ...
    //Recuperer le nom et le prenom de l'etudiant dont son prenom est different de "Mbaye" et son age > 13 
    // $etudiants = Etudiant::where('prenom', '!=','Mbaye')
    // ->where('age','>', 13)
    // ->get(['nom','prenom']);
    // dd($etudiants);


    //Recuperer le prenom de l'etudiant 
